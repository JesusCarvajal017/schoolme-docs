...
\begin{center}
\includegraphics[width=0.5\textwidth]{tables/output 2.png}
\end{center}
III. El ecosistema digital actual demuestra que los desafíos ya no son solo de capacidad técnica, sino de gobernanza consciente. La introducción masiva de sistemas avanzados exige una reflexión interdisciplinaria:
...
\begin{center}
\includegraphics[width=0.5\textwidth]{tables/output 3.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{tables/output 4.png}
\end{center}
\begin{center}
\includegraphics[width=0.5\textwidth]{tables/output 4.1.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{tables/output 5.png}
\end{center}

Propuesta de Investigación y Contribución
\begin{center}
\includegraphics[width=0.5\textwidth]{tables/output 6.png}
\end{center}
